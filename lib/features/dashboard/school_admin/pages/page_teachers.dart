...
class _PageTeachersState extends State<PageTeachers> {
  ...
  void _showManageSheet(BuildContext context, String teacherId) {
    ...
    Future<void> _loadClassSubjects(
        String classId, Function(VoidCallback fn) setSt) async {
      setSt(() => _classSubjects = null);
      try {
        final result = await Supabase.instance.client
            ...
            .eq('class_id', classId)
            .eq('school_id',
                context.read<SchoolAdminProvider>().schoolId);
        setSt(() => _classSubjects = List<Map<String, dynamic>>.from(result));
      } catch (e) {
        debugPrint('Error loading class subjects: $e');
        setSt(() => _classSubjects = []);
      }
    }
    ...
    showModalBottomSheet(
      ...
      builder: (ctx) => DraggableScrollableSheet(
        ...
        builder: (ctx, scrollCtrl) {
          return StatefulBuilder(builder: (sheetContext, setSt) {
            ...
            final formTeacherClassId =
                teacher['formTeacherClassId']?.toString();
                            ...
                            children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                onChanged: (val) => provider
                                    .assignFormTeacher(teacherId, val),
                              ),
                                ...
                                Container(
                                  ...
                                  child: const Row(
                                    children: [
                                      ...
                                      SizedBox(width: 8),
                                      Text(
                                        'Currently assigned as Form Teacher',
                                        style: TextStyle(
                                          color: Colors.white,
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 2),
                                      Text(
                                        'Can teach multiple subjects in multiple classes',
                                        style: TextStyle(
                                          fontSize: 12,
                                          color: Colors.grey.shade500,
                                        ),
                              ...
                              if (_selectedClassIdForSubject != null) ...[
                                ...
                                const Text(
                                  'Step 2: Click subjects to assign/unassign:',
                                  style: TextStyle(
                                    fontSize: 13,
                                  ...
                                  Container(
                                    ...
                                    child: const Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            'No subjects linked to this class yet. Go to Classes > add subjects to this class first.',
                                            style: TextStyle(
                                              color: Color(0xFFE65100),
                                              fontSize: 13,
                                            ),
                                    ...
                                    children: _classSubjects!.map((cs) {
                                      ...
                                      final subjId =
                                          cs['subject_id']
                                              ?.toString() ??
                                              '';
                                      final assigned = assignedSubjects.any(
                                          (a) =>
                                              a['classId'] ==
                                              _selectedClassIdForSubject &&
                                              a['subjectId'] == subjId);

                                      return GestureDetector(
                                        onTap: () {
                                          if (assigned) {
                                            provider.removeSubjectFromTeacher(
                                                teacherId,
                                                subjId,
                                                _selectedClassIdForSubject!);
                                          } else {
                                            provider.assignSubjectToTeacher(
                                                teacherId,
                                                subjId,
                                                _selectedClassIdForSubject!);
                                          }
  ...
  Widget _buildTeacherAvatar(String name, String? passportUrl) {
  ...
  Widget build(BuildContext context) {
    ...
    final formMasterCount = widget.teachers
        .where((t) => t['formTeacherClassId'] != null)
        .length;
    final subjectTeacherCount = widget.teachers
        .where((t) =>
            (List<Map<String, dynamic>>.from(t['assignedSubjects'] ?? []))
                .isNotEmpty)
        .length;
                      ...
                      ? Padding(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                hintText:
                                    'Search by name, staff ID, email, department...',
                                hintStyle: TextStyle(
                                  fontSize: 13,
                                  color: Colors.grey.shade400,
                                  height: 1.4,
          ...
          Expanded(
            child: widget.teachers.isEmpty
                ? _emptyState(
                    ...
                    subtitle: 'Tap "Add New" to register a teacher',
                  )
                : hasSearch && filtered.isEmpty
                    ? _emptyState(
                        ...
                        subtitle:
                            'Try a different name, staff ID or email',
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    _buildTeacherAvatar(name, passportUrl),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                ...
                Row(
                  children: [
                    ...
                    _smallButton(
                      ...
                      color: const Color(0xFF1A237E),
                      onTap: () =>
                          _showManageSheet(context, t['id'].toString()),
                    ),
                  ],
                ),
              ],
              ...
              Padding(
                ...
                child: Wrap(
                  ...
                  children: assignedSubjects.map((a) {
                    final subjName =
                        (a['subjectName'] ?? 'Unknown').toString();
